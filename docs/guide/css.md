...
::: Note
In case vue.config.js file is not present in root of project. You are required to manually add vue.config.js file in the root of project to add necessary changes suggested below.
:::
